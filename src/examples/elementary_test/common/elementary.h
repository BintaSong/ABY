...
/**
 ...
 \param 	num			the number of elements in the tested vector
...
/**
 ...
 \param 	numbers		the number of elements being tested
 \param		ac	 		Arithmetic Circuit object.
 \brief		This function is used to test elementary operation including +, *, AND, XOR, Min, Max, Median, etc.
 */
